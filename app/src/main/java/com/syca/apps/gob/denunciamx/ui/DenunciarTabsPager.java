...
public class DenunciarTabsPager extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_denuncia_tab_pager);
        ...
        mTabsAdapter.addTab(mTabHost.newTabSpec("evidencia").setIndicator("Evidencia"),
                EvidenciaFragment.class, null);
        mTabsAdapter.addTab(mTabHost.newTabSpec("ubicacion").setIndicator("Ubicación"),
                UbicacionDenunciaFragment.class, null);
        mTabsAdapter.addTab(mTabHost.newTabSpec("enviar").setIndicator("Enviar"),
